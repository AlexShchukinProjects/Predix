        ...
        <div class="col-auto">
            @php
                $directoryModules = [
                    [
                        'name' => 'ТИПЫ ВС',
                        'route' => '/settings/Fleet/AircraftTypes'
                    ],
                    [
                        'name' => 'ВОЗДУШНЫЕ СУДА',
                        'route' => '/fleet'
                    ...
                    [
                        'name' => 'ДОЛЖНОСТИ',
                        'route' => '/settings/Position'
                    ],
                    [
                        'name' => 'ТИПЫ ГОТОВНОСТИ',
                        'route' => '/settings/ReadinessType'
                    ],
                    [
                    ...
                    [
                        'name' => 'СТАТУСЫ РЕЙСОВ',
                        'route' => '/settings/FlightStatuses'
                    ],
                    [
                        'name' => 'МИНИМАЛЬНЫЙ СОСТАВ ЭКИПАЖА',
                        'route' => '/minimum_crew'
                    ],
                    [
                        'name' => 'СООБЩЕНИЯ',
                    ...
                    [
                        'name' => 'ТИПЫ ТЕХНИЧЕСКОГО ОБСЛУЖИВАНИЯ',
                        'route' => '/maintenance-types'
                    ]
                ];
            @endphp
            
            @foreach($directoryModules as $module)
