    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h3 mb-0 text-gray-800">Редактировать аэропорт</h1>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('NameRus') is-invalid @enderror" 
                                       id="NameRus" name="NameRus" value="{{ old('NameRus', $airport->NameRus) }}" required>
                                @error('NameRus')
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('NameEng') is-invalid @enderror" 
                                       id="NameEng" name="NameEng" value="{{ old('NameEng', $airport->NameEng) }}">
                                @error('NameEng')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('iata') is-invalid @enderror" 
                                       id="iata" name="iata" value="{{ old('iata', $airport->iata) }}" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('icao') is-invalid @enderror" 
                                       id="icao" name="icao" value="{{ old('icao', $airport->icao) }}" 
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('SummurUTC') is-invalid @enderror" 
                                       id="SummurUTC" name="SummurUTC" value="{{ old('SummurUTC', $airport->SummurUTC) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('WinterUTC') is-invalid @enderror" 
                                       id="WinterUTC" name="WinterUTC" value="{{ old('WinterUTC', $airport->WinterUTC) }}"
                                       placeholder="Например: 4, 4:30 или -5:30">
                                @error('WinterUTC')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea style="width: 100%;" class="form-control @error('Reglament') is-invalid @enderror" 
                                       id="Reglament" name="Reglament" rows="3">{{ old('Reglament', $airport->Reglament) }}</textarea>
                                @error('Reglament')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea style="width: 100%;" class="form-control @error('PDSP_ADP') is-invalid @enderror" 
                                       id="PDSP_ADP" name="PDSP_ADP" rows="3">{{ old('PDSP_ADP', $airport->PDSP_ADP) }}</textarea>
                                @error('PDSP_ADP')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea style="width: 100%;" class="form-control @error('vip') is-invalid @enderror" 
                                       id="vip" name="vip" rows="3">{{ old('vip', $airport->vip) }}</textarea>
                                @error('vip')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea style="width: 100%;" class="form-control @error('Comments') is-invalid @enderror" 
                                       id="Comments" name="Comments" rows="3">{{ old('Comments', $airport->Comments) }}</textarea>
                                @error('Comments')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control @error('Checked') is-invalid @enderror" 
                                       id="Checked" name="Checked" value="{{ old('Checked', $airport->Checked) }}">
                                @error('Checked')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
