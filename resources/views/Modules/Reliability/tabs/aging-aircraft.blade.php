        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div class="d-flex gap-2 align-items-center flex-wrap">
                ...
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="trendCheckAging">Тренд</label>
                </div>
                ...
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="polynomialCheckAging">Степень полинома</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="fleetSizeCheck">
                    <label class="form-check-label" for="fleetSizeCheck">С учетом размера парка ВС</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="valuesCheckAging">
                    <label class="form-check-label" for="valuesCheckAging">Значения</label>
                </div>
            </div>
