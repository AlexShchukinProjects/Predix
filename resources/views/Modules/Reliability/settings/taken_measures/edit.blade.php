...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="h4 mb-0">
            {{ isset($item) ? 'Edit taken measure' : 'Add taken measure' }}
        </h1>
    </div>
    ...
    <div class="card" style="max-width: 800px;">
        ...
        <div class="card-footer d-flex justify-content-between align-items-center">
            <div class="efds-actions mb-0">
                <button form="taken-measure-form" type="submit" class="btn efds-btn efds-btn--primary">Save</button>
                <a href="{{ route('modules.reliability.settings.taken-measures.index') }}" class="btn efds-btn efds-btn--outline-primary">Cancel</a>
            </div>
            @if(isset($item))
                <form method="POST" action="{{ route('modules.reliability.settings.taken-measures.destroy', $item) }}" onsubmit="return confirm('Delete record?');" class="mb-0">
                    @csrf
                    @method('DELETE')
