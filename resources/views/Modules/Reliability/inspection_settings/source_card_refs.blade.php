...
<div class="container-fluid py-3">
    ...
    <div class="card">
        <div class="card-body p-0">
            <form id="form-source-card-refs-table">
                @csrf
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-sm mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-center"><input type="checkbox" name="ids[]" value="{{ $row->id }}" class="form-check-input source-card-refs-row-cb"></td>
                                <td>{{ $row->id }}</td>
                                <td>{{ $row->code }}</td>
                                <td>{{ $row->name }}</td>
...
<div class="modal fade" id="sourceCardRefsUploadModal" tabindex="-1" aria-labelledby="sourceCardRefsUploadModalLabel" aria-hidden="true">
...
<script>
(function() {
    var formDelete = document.getElementById('form-delete-source-card-refs');
    var checkboxes = document.querySelectorAll('.source-card-refs-row-cb');
    var selectAll = document.getElementById('source-card-refs-select-all');
    ...
    function updateSelectAll() {
        if (!selectAll) return;
        var all = document.querySelectorAll('.source-card-refs-row-cb');
        var checked = document.querySelectorAll('.source-card-refs-row-cb:checked');
    ...
    if (selectAll) {
        selectAll.addEventListener('change', function() {
            Array.prototype.forEach.call(document.querySelectorAll('.source-card-refs-row-cb'), function(cb) { cb.checked = selectAll.checked; });
    ...
    formDelete.addEventListener('submit', function(e) {
        e.preventDefault();
        var ids = [];
        document.querySelectorAll('.source-card-refs-row-cb:checked').forEach(function(cb) { ids.push(cb.value); });
    ...
    var uploadModal = document.getElementById('sourceCardRefsUploadModal');
    var dropzone = document.getElementById('source-card-refs-upload-dropzone');
    var fileInput = document.getElementById('source-card-refs-upload-file');
    var filenameEl = document.getElementById('source-card-refs-upload-filename');
    var submitBtn = document.getElementById('source-card-refs-upload-submit');
