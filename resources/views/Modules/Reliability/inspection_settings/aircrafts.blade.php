...
<div class="container-fluid py-3">
    ...
    <div class="efds-table-header">
        <div class="efds-table-header__stats text-muted">
            ...
            <select class="form-select form-select-sm" id="aircrafts-per-page" aria-label="Записей на странице">
        ...
        <div class="efds-table-header__actions">
            <button type="button" class="btn efds-btn efds-btn--outline-primary btn-sm" data-bs-toggle="modal" data-bs-target="#aircraftsUploadModal"><i class="fas fa-file-excel me-1"></i>Добавить из Excel / CSV</button>
            ...
            <div class="reliability-table-scroll-wrap">
                <div class="table-responsive">
                    ...
                    <thead class="table-light">
                        <tr>
                            <th class="text-center" style="width: 2.5rem;"><input type="checkbox" id="aircrafts-select-all" class="form-check-input" title="Выбрать все на странице"></th>
                            <th>id</th>
                            <th>SERIAL #</th>
                            <th>TAIL #</th>
                            <th>AIRCRAFT TYPE</th>
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr><td colspan="61" class="text-muted">Нет данных. Загрузите CSV или XLSX.</td></tr>
                        @endforelse
                    </tbody>
                    </table>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="aircraftsUploadModalLabel">Добавить из Excel / CSV</h5>
            ...
            <form id="form-upload-aircrafts-modal" action="{{ route('modules.reliability.settings.inspection.aircrafts.upload') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    <div class="efds-actions mb-0">
                        ...
                        <button type="submit" id="aircrafts-upload-submit" class="btn efds-btn efds-btn--primary" disabled>Загрузить</button>
                    </div>
                </div>
            </form>
        </div>
